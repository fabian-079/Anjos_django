...
from adapters.api.simple_checkout_views import (
    simple_checkout_view, simple_payment_success_view, simple_buy_now_ajax, create_stripe_checkout, clear_cart_api
)
from adapters.api.report_views import (
    reports_index, report_sales_pdf, report_inventory_pdf, report_users_pdf, report_preview
)
from adapters.api.seeder_views import seeder_form, seeder_run, seeder_upload_csv, seeder_template_download
...
urlpatterns = [
    ...
    # Seeder / carga masiva de datos
    path('seeder/', seeder_form, name='seeder_form'),
    path('seeder/run/', seeder_run, name='seeder_run'),
    path('seeder/upload/', seeder_upload_csv, name='seeder_upload_csv'),
    path('seeder/template/', seeder_template_download, name='seeder_template_download'),
    ...
    # Pasarela de Pagos - COMPLETAMENTE DESHABILITADA
    ...
    # Webhooks de pagos - DESHABILITADOS
